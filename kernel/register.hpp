...
* @file register.hpp
*
* provide functionalities to read/write memory mapped register 
*/
...
*
* Each element may have a flag indicating availablity of the element.
...
class ArrayWrapper {
    public:
        ...
        // to be used in range-based for statements.
