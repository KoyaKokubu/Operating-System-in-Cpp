/*
* classes indicating USB device, and some functionalities
*/
...
namespace usb::xhci {
    class Device : public usb::Device {
        public:
            ...
            Error InterruptIn(EndpointID ep_id, void* but, int len) override;
            Error InterruptOut(EndpointID ep_id, void* but, int len) override;
        ...
        private:
            ...
            /** Map to search corresponded SetupStageTRB with DataStageTRB or StatusStageTRB
            *   when control transfer is completed.
            */
