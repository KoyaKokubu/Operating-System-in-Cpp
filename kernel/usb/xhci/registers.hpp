/*
* definition of registers of xHCI
*/
...
namespace usb::xhci {
    ...
    union HCCPARAMS2_Bitmap {
        ...
        struct {
            ...
            uint32_t configure_endpoint_context_capability : 1;
    ...
    /** @brief common header composition for extended register */
    ...
    class ExtendedRegisterList {
        public:
            ...
            ExtendedRegisterList(uint64_t mmion_base, HCCPARAMS1_Bitmap hccp);
    ...
    /**** definition of distinct extended register ****/
