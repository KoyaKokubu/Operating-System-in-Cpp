/**
*  class to regulate xHCI host controller
*/
...
namespace usb::xhci {
    ...
    /** @brief Cope with at most one event added to Event Ring.
    *
    *   Cope with the head event of the Primary Event Ring of xhc.
    *   Return Error::kSuccess promptly if no events.
    *
    *   @return Error::kSuccess if coping with event safely.
    */
