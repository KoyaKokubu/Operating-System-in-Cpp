...
const PixelColor kDesktopBtmRhtColor{50, 50, 50};
const PixelColor kDesktopBtmLftColor{80, 80, 80};

const uint32_t windowFGColor = 0x00ffff;
const uint32_t windowBGColor = 0x323232;

const uint32_t terminalFGColor = 0x00ffff;
const uint32_t terminalBGColor = 0x000000;

void DrawDesktop(PixelWriter& wirter);
