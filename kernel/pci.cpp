...
namespace {
    ...
    /** @brief set devices[num_device] and increment num_device*/
    ...
    /** @brief add a function into devices. 
    *   If it is PCI-PCI bridge, run ScanBus() for the secondary bus
    */
    ...
    /** @brief scan each function of the device number.
    *   Run ScanFunction() if finding a valid function.
    */
    ...
    /** @brief scan each device of the bus.
    *   Run ScanDevice() if finding a valid device
    */
    Error ScanBus(uint8_t bus) {
    ...
    /** @brief read the given MSI capability configuration
    * 
    *   @param dev : PCI device to read MSI capability
    *   @param cap_addr : configuration space address of MSI capability register
    */
    ...
    /** @brief write into the given MSI cpability configuration
    *
    *   @param dev : PCI device to read MSI capability
    *   @param cap_addr : configuration space address of MSI capability register
    *   @param msi_cap : value to write
    */
    ...
    /** @brief set the given MSI register */
