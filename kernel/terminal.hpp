...
class Terminal {
    public:
        ...
        Rectangle<int> InputKey(uint8_t modifier, uint8_t keycode, char ascii);
				...
				void Print(const char* s, const PixelColor& color={255, 255, 255}, std::optional<size_t> len = std::nullopt);
    ...
    private:
        ...
        void Print(char32_t c, const PixelColor& color={255, 255, 255});
